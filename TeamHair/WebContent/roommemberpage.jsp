			...
			<div class="row align-items-center justify-content-between d-flex">
				...
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						...
						<li class="menu-active"><a href="#">예약 관리</a></li>
						<li class="menu-active"><a href="log-in.jsp">instagrak</a></li>
						<li class="menu-active"><a href="log-in.jsp">profile</a></li>
						<li class="menu-active"><a href="sign-up.jsp">log-out</a></li>
					</ul>
