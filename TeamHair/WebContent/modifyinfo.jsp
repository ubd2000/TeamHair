	...
	<div class="container">
		<div class="row contents_modify">
			<div class="col-lg-3 col-md-3 col-xs-3 col-sm-3 modifymenu">
				<ul>
					<a href="modifyinfo.jsp"><li>프로필 수정</li></a>
					<a href="modifypwd.jsp"><li>비밀번호 변경</li></a>
				</ul>
			</div>
			...
			<div class="col-lg-9 col-md-9 col-xs-9 col-sm-9 modifycontent">
				<form action="" method="POST">
					<div class="modifycontentsession1">
						...
						<p>
							<strong>아이디</strong><br> <a href="#">프로필 사진 바꾸기</a>
						</p>
					</div>

					<div class="modifycontentsession2">
						<label class="col-md-3 labelcss" for="name">이름</label> <input
							type="text" id="name" name="name"
							class="col-md-6 inputcss form-control">
					</div>
					<div class="modifycontentsession2">
						<label class="col-md-3 labelcss" for="username">사용자 이름</label> <input
							type="text" id="username" name="username"
							class="col-md-6 inputcss form-control">
					</div>
					<div class="modifycontentsession2">
						<label class="col-md-3 labelcss" for="website">웹사이트</label> <input
							type="text" id="website" name="website"
							class="col-md-6 inputcss form-control">
					</div>
					<div class="modifycontentsession2">
						<label class="col-md-3 labelcss" for="intro">소개</label> <input
							type="text" id="intro" name="intro"
							class="col-md-6 inputcss form-control">
					</div>
					<div class="modifycontentsession2">
						<label class="col-md-3 labelcss" for="email">이메일</label> <input
							type="text" id="email" name="email"
							class="col-md-6 inputcss form-control">
					</div>
					<div class="modifycontentsession2">
						<label class="col-md-3 labelcss" for="phone">전화번호</label> <input
